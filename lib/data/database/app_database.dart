...
class AppDatabase {
  ...
  Future<void> seedEmployees(Database db) async {
    ...
    for (final e in const [
      ...
      batch.insert('employees', e.toMap());
    }
    await batch.commit(noResult: true);
  }
  ...
  void _createSchemaV2(Batch batch) {
    ...
    batch.execute('''
      CREATE TABLE employees (
        id TEXT PRIMARY KEY,
        name TEXT NOT NULL,
        -- Plain-text PIN: a documented shortcut for a local demo till. See the
        -- note on Employee.pin — hashing here would protect nothing.
        pin TEXT NOT NULL,
        role TEXT NOT NULL,
        active INTEGER NOT NULL DEFAULT 1,
        sort_order INTEGER NOT NULL DEFAULT 0
