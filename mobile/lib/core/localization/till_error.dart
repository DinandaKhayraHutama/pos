...
String tillErrorMessage(BuildContext context, TillOperationException error) =>
    switch (error.code) {
      ...
      'cashier_required' => context.l10n.tillLoginRequired,
      'session_not_confirmed' ||
      'session_closed' ||
      'session_not_owned' => context.l10n.tillSessionUnconfirmed,
