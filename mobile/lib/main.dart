...
import 'features/activation/backend_app.dart';
...
Future<void> main() async {
  ...
  if (backendApiUrl.isNotEmpty) {
    runApp(
      BackendApp(
        initialPreferences: prefs,
        appBuilder: (connected) =>
            NtiPosApp(brand: connected.brand, themeMode: connected.themeMode),
      ),
    );
    return;
  }
