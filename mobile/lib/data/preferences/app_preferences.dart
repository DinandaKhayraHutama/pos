...
class AppPreferences {
  ...
  final _ScopedPreferences _prefs;
  static String _scope = '';

  static void configureScope(String scope) {
    _scope = 'connected_${scope}_';
    _instance = null;
  }
  ...
  static Future<AppPreferences> instance() async {
    ...
    return _instance = AppPreferences._(_ScopedPreferences(prefs, _scope));
  }
  ...
  double get serviceChargeRate => _prefs.getDouble(_kServiceChargeRate) ?? 5.0;
  ...
  Future<void> setPosSessionId(String v) => _prefs.setString(_kPosSessionId, v);
...
class _ScopedPreferences {
  const _ScopedPreferences(this.preferences, this.prefix);
  final SharedPreferences preferences;
  final String prefix;

  String? getString(String key) => preferences.getString('$prefix$key');
  bool? getBool(String key) => preferences.getBool('$prefix$key');
  double? getDouble(String key) => preferences.getDouble('$prefix$key');
  bool containsKey(String key) => preferences.containsKey('$prefix$key');
  Future<bool> setString(String key, String value) =>
      preferences.setString('$prefix$key', value);
  Future<bool> setBool(String key, bool value) =>
      preferences.setBool('$prefix$key', value);
