...
class ProductCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // An activated till never refuses a sale over its own count. That count is
    // a local view of a shared shelf — a delivery the Backoffice booked may not
    // have been pulled yet — and a sale that happened is recorded as a
    // shortfall rather than lost. The demo keeps blocking at zero.
    final sellable =
        product.available &&
        (TillBinding.current != null || !product.isOutOfStock);
              ...
              SizedBox(
                ...
                child: Row(
                  children: [
                    ...
                    if (hasVariants)
                      Icon(Icons.tune_rounded, size: 13, color: design.textLow),
                  ],
                ),
              ),
