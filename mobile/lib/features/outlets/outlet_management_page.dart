            ...
            data: (list) {
              ...
              return ListView.separated(
                ...
                itemBuilder: (_, i) => _OutletTile(
                  ...
                  // An activated device stands where its token is bound.
                  onUseHere: TillBinding.current != null
                      ? null
                      : () => ref
...
class _OutletTile extends StatelessWidget {
  ...
  /// Null when the device cannot be moved (it is bound to its outlet).
        ...
        children: [
          ...
          Wrap(
            ...
            children: [
              ...
              else if (outlet.active && onUseHere != null)
                TextButton.icon(
                  onPressed: onUseHere,
