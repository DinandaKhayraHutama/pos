...
([.Codex/rules/testing-policy.md](../../rules/testing-policy.md)): per-feature widget/integration/E2E
...
`flutter build ios --no-tree-shake-icons` + `simctl install` pattern from AGENTS.md. Emoji never
...
(see AGENTS.md Gotchas) passed at 480px and blanked the app at 1280px. When a change touches
